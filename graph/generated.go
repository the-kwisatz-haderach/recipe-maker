...
func (ec *executionContext) field_Mutation_createRecipe_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewRecipe2githubᚗcomᚋtheᚑkwisatzᚑhaderachᚋrecipemakerᚋgraphᚋmodelᚐNewRecipe(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNNewRecipe2githubᚗcomᚋtheᚑkwisatzᚑhaderachᚋrecipemakerᚋgraphᚋmodelᚐNewRecipe(ctx context.Context, v interface{}) (model.NewRecipe, error) {
